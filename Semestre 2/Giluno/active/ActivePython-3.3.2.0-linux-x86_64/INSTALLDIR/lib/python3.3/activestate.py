...
version_info = {'bsddb_ver': None,
 'build_host': 'python-linux64-vm',
 'build_num': 0,
 'build_plat_fullname': 'linux2.6-fedoracore4-libc6-glibc2.3-libcpp6-x86_64',
 'build_plat_name': 'linux-x86_64',
 'build_time': 'Mon Sep 16 23:14:20 2013',
 'bzip2_ver': (1, 0, 6),
 'compiler': 'gcc',
 'configuration': ['-f',
                   'apyconfig-apy33-rrun.py',
                   '-p',
                   'apy33',
                   '--build-tag',
                   'rrun'],
 ...
 'platinfo': {'arch': 'x86_64',
              'distro': 'FedoraCore',
              'distro_codename': 'Stentz',
              'distro_desc': 'Fedora Core release 4 (Stentz)',
              'distro_ver': '4',
              'glibc': 'glibc',
              'glibc_ver': '2.3.6',
              'libc': 'libc6',
 ...
 'python_src': ('3.3.2',
                'url',
                'http://lang.nas.activestate.com/ActivePython/src/Python-3.3.2.tgz'),
 'pywin32_build': None,
 'pywin32_src': None,
 'pywin32_ver': None,
 'scm_revision': 'r82125-trunk',
 'sqlite3_ver': (3, 7, 12),
 'tcltk_ver': (8, 5, 9),
 'tix_ver': (8, 4, 3),
 'with_bsddb': False,
...
compiler_info = """gcc (GCC) 4.0.2 20051125 (Red Hat 4.0.2-8)"""


# Used for Python install relocation.
prefixes = set([
    # Prefix to which extensions were built
    '/home/apy/rrun/build/activepython-svn-trunk/build/py3_3_2-linux-x86_64-apy33-rrun/ExTAcTiVePyThOnPrEfIxExTAcTiVePyThOnPrEfIxExTAcTiVePyThOnPrEfIxExTAcTiVePyThOnPrEfIxExTAcTiVePyThOnPrEfIxExTAcTiVePyThOnPrEfIxExTAcTiVePyThOnPrEfIxExTAcTiVePyThOnPrEfIxExTAcTiVePyThOnPrEfIxExTAcTiVePyThOnPrEfIx',
    # Prefix to which Python sources were built.
    '/home/apy/rrun/build/activepython-svn-trunk/build/py3_3_2-linux-x86_64-apy33-rrun/CoReAcTiVePyThOnPrEfIxCoReAcTiVePyThOnPrEfIxCoReAcTiVePyThOnPrEfIxCoReAcTiVePyThOnPrEfIxCoReAcTiVePyThOnPrEfIxCoReAcTiVePyThOnPrEfIxCoReAcTiVePyThOnPrEfIxCoReAcTiVePyThOnPrEfIxCoReAcTiVePyThOnPrEfIxCoReAcTiVePyThOnPrEfIx',
    # Prefix to the Python image (sys.prefix)
    # (relied by pypm -- for relocation)
    '/home/apy/rrun/build/activepython-svn-trunk/build/py3_3_2-linux-x86_64-apy33-rrun/image/opt/ActivePython-3.3',
])
shortest_original_prefix_length = 292
