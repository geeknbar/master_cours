...
// creation de get mais comme je n'y arrive pas je les passe en public
//	Node<T, NodePolicy> getParent(){return parent};
//	Node<T, NodePolicy>*> getOffspring(){return offspring};
